...
2. **SYSTEM patterns** (fallback): `skills/PAI/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml`
...
1. Create `USER/PAISECURITYSYSTEM/patterns.yaml` (copy from `skills/PAI/SYSTEM/PAISECURITYSYSTEM/patterns.example.yaml`)
