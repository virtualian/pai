...
3. **Use Theme Constants:**
   ```
   ~/.pai/skills/Remotion/Tools/Theme.ts
   ```
...
```typescript
import { PAI_THEME } from '~/.pai/skills/Remotion/Tools/Theme'
...
```typescript
import { PAI_THEME, titleScreenStyle, fadeInterpolation } from '~/.pai/skills/Remotion/Tools/Theme'
