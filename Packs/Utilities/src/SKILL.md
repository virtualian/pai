...
| Upgrade, improve system, check Anthropic, system upgrade, analyze for improvements, new Claude features, find sources, research upgrade, PAI upgrade | `PAIUpgrade/SKILL.md` |
| Mine reflections, mine ratings, algorithm upgrade, improve the algorithm, what have we learned, internal improvements, reflection insights, behavioral patterns, learning synthesis, close the loop | `Learning/SKILL.md` |
