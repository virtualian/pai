...
| `~/.pai/agents/BrowserAgent.md` | AI-driven browser agent definition |
| `~/.pai/agents/UIReviewer.md` | User story validation agent definition |

## Related

- [BrowserAgent](~/.pai/agents/BrowserAgent.md)
- [UIReviewer](~/.pai/agents/UIReviewer.md)
