...
**Location:** `~/.pai/skills/Utilities/Fabric/Patterns/`
...
```bash
~/.pai/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `~/.pai/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/.pai/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
