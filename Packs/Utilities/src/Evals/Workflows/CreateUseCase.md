...
```bash
mkdir -p ~/.pai/skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/.pai/skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `~/.pai/skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/.pai/skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `~/.pai/skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run ~/.pai/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la ~/.pai/skills/Utilities/Evals/UseCases/<name>/
