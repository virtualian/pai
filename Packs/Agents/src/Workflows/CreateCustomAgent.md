...
bun run ~/.pai/skills/Agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `~/.pai/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `~/.pai/skills/Agents/AgentPersonalities.md`
