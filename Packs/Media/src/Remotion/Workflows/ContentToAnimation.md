...
# Load: ~/.pai/skills/Utilities/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '~/.pai/skills/Media/Remotion/theme'
...
- Reference: `~/.pai/skills/Media/Remotion/theme.ts`
